        ...
        try {
          ...
          try {
            if (legal_task) {
              ...
              console.log("1 targetState ", targetState)
              ...
              if (warning_list_map.has(String(user_id))) {
                functions.logger.info("the user ", user_id, " is on the warning list. attempting to delete it");
